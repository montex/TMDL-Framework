...
/**
 * This is the item provider adapter for a {@link san.ComplexType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComplexType_definition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComplexType_definition_feature", "_UI_ComplexType_type"),
				 SANPackage.Literals.COMPLEX_TYPE__DEFINITION,
				 true,
				 false,
				 true,
				 null,
