...
/**
 * This is the item provider adapter for a {@link san.Binomial} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BinomialItemProvider extends DistributionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SANPackage.Literals.BINOMIAL__T);
			childrenFeatures.add(SANPackage.Literals.BINOMIAL__P);
		}
	...
	public String getText(Object object) {
		String label = ((Binomial)object).getParameters();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SANPackage.Literals.BINOMIAL__T,
				 SANFactory.eINSTANCE.createExpression()));

		newChildDescriptors.add
			(createChildParameter
				(SANPackage.Literals.BINOMIAL__P,
				 SANFactory.eINSTANCE.createExpression()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == SANPackage.Literals.BINOMIAL__T ||
			childFeature == SANPackage.Literals.BINOMIAL__P;
