...
public class ExpressionVariableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExpressionVariable_variable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExpressionVariable_variable_feature", "_UI_ExpressionVariable_type"),
				 SANPackage.Literals.EXPRESSION_VARIABLE__VARIABLE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_ExpressionVariable_type");
	}
