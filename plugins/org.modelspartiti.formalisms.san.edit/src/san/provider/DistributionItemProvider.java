...
public class DistributionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Distribution_parameters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Distribution_parameters_feature", "_UI_Distribution_type"),
				 SANPackage.Literals.DISTRIBUTION__PARAMETERS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Distribution)object).getParameters();
