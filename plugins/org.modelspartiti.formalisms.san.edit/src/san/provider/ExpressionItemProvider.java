...
public class ExpressionItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SANPackage.Literals.EXPRESSION__SEGMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SANPackage.Literals.EXPRESSION__SEGMENTS,
				 SANFactory.eINSTANCE.createExpressionText()));

		newChildDescriptors.add
			(createChildParameter
				(SANPackage.Literals.EXPRESSION__SEGMENTS,
				 SANFactory.eINSTANCE.createExpressionMarking()));

		newChildDescriptors.add
			(createChildParameter
				(SANPackage.Literals.EXPRESSION__SEGMENTS,
				 SANFactory.eINSTANCE.createExpressionVariable()));
	}
