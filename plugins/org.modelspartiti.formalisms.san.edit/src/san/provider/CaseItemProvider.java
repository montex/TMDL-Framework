...
public class CaseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Case_ID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Case_ID_feature", "_UI_Case_type"),
				 SANPackage.Literals.CASE__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SANPackage.Literals.CASE__P);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Case_type") + " " + case_.getID();
	}
