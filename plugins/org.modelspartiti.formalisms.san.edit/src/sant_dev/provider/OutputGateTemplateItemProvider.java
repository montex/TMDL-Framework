 ...
 * @generated
 */
public class OutputGateTemplateItemProvider extends GateItemProvider {
	/**
	...
	protected void addPlaceTemplatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutputGateTemplate_placeTemplate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutputGateTemplate_placeTemplate_feature", "_UI_OutputGateTemplate_type"),
				 SANT_DEVPackage.Literals.OUTPUT_GATE_TEMPLATE__PLACE_TEMPLATE,
				 true,
				 false,
				 true,
				 null,
