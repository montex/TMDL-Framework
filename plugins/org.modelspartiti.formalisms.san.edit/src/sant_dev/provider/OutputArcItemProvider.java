...
/**
 * This is the item provider adapter for a {@link sant_dev.OutputArc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SANT_DEVPackage.Literals.OUTPUT_ARC__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SANT_DEVPackage.Literals.OUTPUT_ARC__TARGET,
				 true,
				 false,
				 true,
				 null,
