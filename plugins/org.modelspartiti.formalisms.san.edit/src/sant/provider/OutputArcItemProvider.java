...
/**
 * This is the item provider adapter for a {@link sant.OutputArc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputArcItemProvider extends ArcTemplateItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSourceCaseConcretePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Source Case Concrete feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSourceCaseConcretePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutputArc_sourceCaseConcrete_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutputArc_sourceCaseConcrete_feature", "_UI_OutputArc_type"),
				 SANTPackage.Literals.OUTPUT_ARC__SOURCE_CASE_CONCRETE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutputArc_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutputArc_source_feature", "_UI_OutputArc_type"),
				 SANTPackage.Literals.OUTPUT_ARC__SOURCE,
				 true,
				 false,
				 true,
				 null,
