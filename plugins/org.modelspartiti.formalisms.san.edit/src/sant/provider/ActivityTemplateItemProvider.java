...
/**
 * This is the item provider adapter for a {@link sant.ActivityTemplate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityTemplateItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SANTPackage.Literals.ACTIVITY_TEMPLATE__CASES_TEMPLATE);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(SANTPackage.Literals.ACTIVITY_TEMPLATE__CASES_TEMPLATE,
				 SANTFactory.eINSTANCE.createCasesSpecificationConcrete()));

		newChildDescriptors.add
			(createChildParameter
				(SANTPackage.Literals.ACTIVITY_TEMPLATE__CASES_TEMPLATE,
				 SANTFactory.eINSTANCE.createCasesSpecificationArray()));
