...
/**
 * This is the item provider adapter for a {@link tmdl.library.Block} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Block_labels_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Block_labels_feature", "_UI_Block_type"),
				 LibraryPackage.Literals.BLOCK__LABELS,
				 true,
				 false,
				 false,
	...
	protected void addRequiredInterfacesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Block_requiredInterfaces_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Block_requiredInterfaces_feature", "_UI_Block_type"),
				 LibraryPackage.Literals.BLOCK__REQUIRED_INTERFACES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LibraryPackage.Literals.BLOCK__MULTIPLICITY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LibraryPackage.Literals.BLOCK__MULTIPLICITY,
