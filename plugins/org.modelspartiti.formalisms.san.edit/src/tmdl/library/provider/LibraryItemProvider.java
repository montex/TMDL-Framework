...
/**
 * This is the item provider adapter for a {@link tmdl.library.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LibraryItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LibraryPackage.Literals.LIBRARY__INTERFACES);
			childrenFeatures.add(LibraryPackage.Literals.LIBRARY__TEMPLATES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LibraryPackage.Literals.LIBRARY__INTERFACES,
				 LibraryFactory.eINSTANCE.createModelInterface()));

		newChildDescriptors.add
			(createChildParameter
				(LibraryPackage.Literals.LIBRARY__TEMPLATES,
				 LibraryFactory.eINSTANCE.createTemplateAtomic()));

		newChildDescriptors.add
			(createChildParameter
				(LibraryPackage.Literals.LIBRARY__TEMPLATES,
				 LibraryFactory.eINSTANCE.createTemplateComposite()));
	}
