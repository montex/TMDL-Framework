 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelspartiti.infrastructure.tmdl.expressions.impl.TemplateExpressionBooleanToIntegerImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TemplateExpressionBooleanToIntegerImpl extends MinimalEObjectImpl.Container implements TemplateExpressionBooleanToInteger {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate EVALUATE_ELIST__EINVOCATION_DELEGATE = ((EOperation.Internal)ExpressionsPackage.Literals.TEMPLATE_EXPRESSION_BOOLEAN_TO_INTEGER___EVALUATE__ELIST).getInvocationDelegate();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ExpressionsPackage.TEMPLATE_EXPRESSION_BOOLEAN_TO_INTEGER___EVALUATE:
				return evaluate();
		}
