 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelspartiti.infrastructure.tmdl.expressions.impl.TemplateExpressionRealFromIntegerImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TemplateExpressionRealFromIntegerImpl extends MinimalEObjectImpl.Container implements TemplateExpressionRealFromInteger {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate EVALUATE_ELIST__EINVOCATION_DELEGATE = ((EOperation.Internal)ExpressionsPackage.Literals.TEMPLATE_EXPRESSION_REAL_FROM_INTEGER___EVALUATE__ELIST).getInvocationDelegate();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExpressionsPackage.TEMPLATE_EXPRESSION_REAL_FROM_INTEGER___EVALUATE__ELIST:
				return evaluate((EList<Assignment>)arguments.get(0));
			case ExpressionsPackage.TEMPLATE_EXPRESSION_REAL_FROM_INTEGER___EVALUATE:
				return evaluate();
		}
