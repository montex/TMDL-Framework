 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelspartiti.infrastructure.tmdl.impl.TemplateAtomicImpl#getSource <em>Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TemplateAtomicImpl extends TemplateSpecificationImpl implements TemplateAtomic {
	...
	protected EClass eStaticClass() {
		return tmdlPackage.Literals.TEMPLATE_ATOMIC;
	}
	...
	public void setSource(String newSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, tmdlPackage.TEMPLATE_ATOMIC__SOURCE, oldSource, source));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case tmdlPackage.TEMPLATE_ATOMIC__SOURCE:
				return getSource();
		}
