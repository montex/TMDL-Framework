...
public class TemplateExpressionRealFromIntegerImpl extends MinimalEObjectImpl.Container implements TemplateExpressionRealFromInteger {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate EVALUATE_LIST__EINVOCATION_DELEGATE = ((EOperation.Internal)ExpressionsPackage.Literals.TEMPLATE_EXPRESSION_REAL_FROM_INTEGER___EVALUATE__LIST).getInvocationDelegate();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExpressionsPackage.TEMPLATE_EXPRESSION_REAL_FROM_INTEGER___EVALUATE__LIST:
