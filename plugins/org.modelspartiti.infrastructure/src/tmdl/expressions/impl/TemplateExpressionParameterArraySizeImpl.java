...
public class TemplateExpressionParameterArraySizeImpl extends MinimalEObjectImpl.Container implements TemplateExpressionParameterArraySize {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate EVALUATE_LIST__EINVOCATION_DELEGATE = ((EOperation.Internal)ExpressionsPackage.Literals.TEMPLATE_EXPRESSION_PARAMETER_ARRAY_SIZE___EVALUATE__LIST).getInvocationDelegate();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExpressionsPackage.TEMPLATE_EXPRESSION_PARAMETER_ARRAY_SIZE___EVALUATE__LIST:
