...
public class TemplateExpressionBooleanAndImpl extends MinimalEObjectImpl.Container implements TemplateExpressionBooleanAnd {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate EVALUATE_LIST__EINVOCATION_DELEGATE = ((EOperation.Internal)ExpressionsPackage.Literals.TEMPLATE_EXPRESSION_BOOLEAN_AND___EVALUATE__LIST).getInvocationDelegate();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExpressionsPackage.TEMPLATE_EXPRESSION_BOOLEAN_AND___EVALUATE__LIST:
