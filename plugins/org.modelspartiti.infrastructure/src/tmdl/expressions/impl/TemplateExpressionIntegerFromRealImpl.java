...
public class TemplateExpressionIntegerFromRealImpl extends MinimalEObjectImpl.Container implements TemplateExpressionIntegerFromReal {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate EVALUATE_LIST__EINVOCATION_DELEGATE = ((EOperation.Internal)ExpressionsPackage.Literals.TEMPLATE_EXPRESSION_INTEGER_FROM_REAL___EVALUATE__LIST).getInvocationDelegate();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExpressionsPackage.TEMPLATE_EXPRESSION_INTEGER_FROM_REAL___EVALUATE__LIST:
				return evaluate((List<Assignment>)arguments.get(0));
			case ExpressionsPackage.TEMPLATE_EXPRESSION_INTEGER_FROM_REAL___EVALUATE:
				return evaluate();
		}
