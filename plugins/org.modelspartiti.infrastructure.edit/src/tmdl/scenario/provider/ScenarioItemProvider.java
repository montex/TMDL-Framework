...
/**
 * This is the item provider adapter for a {@link tmdl.scenario.Scenario} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioItemProvider 
	...
	protected void addRootPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scenario_root_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scenario_root_feature", "_UI_Scenario_type"),
				 ScenarioPackage.Literals.SCENARIO__ROOT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScenarioPackage.Literals.SCENARIO__VARIANTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.SCENARIO__VARIANTS,
				 ScenarioFactory.eINSTANCE.createVariantAtomic()));

		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.SCENARIO__VARIANTS,
				 ScenarioFactory.eINSTANCE.createVariantComposite()));
	}
