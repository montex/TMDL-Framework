...
/**
 * This is the item provider adapter for a {@link tmdl.scenario.Variant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariantItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScenarioPackage.Literals.VARIANT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScenarioPackage.Literals.VARIANT__ASSIGNMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.VARIANT__ASSIGNMENTS,
				 CoreFactory.eINSTANCE.createAssignmentSimple()));

		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.VARIANT__ASSIGNMENTS,
				 CoreFactory.eINSTANCE.createAssignmentArray()));
	}
