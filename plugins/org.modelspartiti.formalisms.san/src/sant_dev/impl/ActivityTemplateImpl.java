 ...
 * </p>
 * <ul>
 *   <li>{@link sant_dev.impl.ActivityTemplateImpl#getCasesTemplate <em>Cases Template</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ActivityTemplateImpl extends NamedElementImpl implements ActivityTemplate {
	...
	protected EClass eStaticClass() {
		return SANT_DEVPackage.Literals.ACTIVITY_TEMPLATE;
	}
	...
	public NotificationChain basicSetCasesTemplate(CasesSpecification newCasesTemplate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SANT_DEVPackage.ACTIVITY_TEMPLATE__CASES_TEMPLATE, oldCasesTemplate, newCasesTemplate);
	...
	public void setCasesTemplate(CasesSpecification newCasesTemplate) {
		if (newCasesTemplate != casesTemplate) {
			...
			if (casesTemplate != null)
				msgs = ((InternalEObject)casesTemplate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SANT_DEVPackage.ACTIVITY_TEMPLATE__CASES_TEMPLATE, null, msgs);
			if (newCasesTemplate != null)
				msgs = ((InternalEObject)newCasesTemplate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SANT_DEVPackage.ACTIVITY_TEMPLATE__CASES_TEMPLATE, null, msgs);
			msgs = basicSetCasesTemplate(newCasesTemplate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANT_DEVPackage.ACTIVITY_TEMPLATE__CASES_TEMPLATE, newCasesTemplate, newCasesTemplate));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SANT_DEVPackage.ACTIVITY_TEMPLATE__CASES_TEMPLATE:
