 ...
 * </p>
 * <ul>
 *   <li>{@link sant_dev.impl.MarkingTemplateImpl#getIdPlace <em>Id Place</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MarkingTemplateImpl extends MinimalEObjectImpl.Container implements MarkingTemplate {
	...
	protected EClass eStaticClass() {
		return SANT_DEVPackage.Literals.MARKING_TEMPLATE;
	}
	...
	public void setIdPlace(int newIdPlace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANT_DEVPackage.MARKING_TEMPLATE__ID_PLACE, oldIdPlace, idPlace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SANT_DEVPackage.MARKING_TEMPLATE__ID_PLACE:
				return getIdPlace();
		}
