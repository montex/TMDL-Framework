 ...
 * </p>
 * <ul>
 *   <li>{@link sant_dev.MarkingTemplate#getIdPlace <em>Id Place</em>}</li>
 * </ul>
 *
 * @see sant_dev.SANT_DEVPackage#getMarkingTemplate()
 * @model abstract="true"
 * @generated
 */
public interface MarkingTemplate extends EObject {
	 ...
	 * @see #setIdPlace(int)
	 * @see sant_dev.SANT_DEVPackage#getMarkingTemplate_IdPlace()
	 * @model required="true"
	 * @generated
	 */
	int getIdPlace();
	...
	/**
	 * Sets the value of the '{@link sant_dev.MarkingTemplate#getIdPlace <em>Id Place</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
