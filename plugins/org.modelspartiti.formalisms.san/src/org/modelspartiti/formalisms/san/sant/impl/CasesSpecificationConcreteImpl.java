 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelspartiti.formalisms.san.sant.impl.CasesSpecificationConcreteImpl#getCases <em>Cases</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CasesSpecificationConcreteImpl extends CasesSpecificationImpl implements CasesSpecificationConcrete {
	...
	protected EClass eStaticClass() {
		return SANTPackage.Literals.CASES_SPECIFICATION_CONCRETE;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SANTPackage.CASES_SPECIFICATION_CONCRETE__CASES:
