...
import org.modelspartiti.formalisms.san.sant.ActivityTemplate;
import org.modelspartiti.formalisms.san.sant.ArcTemplate;
import org.modelspartiti.formalisms.san.sant.CasesSpecification;
import org.modelspartiti.formalisms.san.sant.CasesSpecificationArray;
import org.modelspartiti.formalisms.san.sant.CasesSpecificationConcrete;
import org.modelspartiti.formalisms.san.sant.CasesSpecificationParametric;
import org.modelspartiti.formalisms.san.sant.CasesSpecificationProbabilityArray;
import org.modelspartiti.formalisms.san.sant.GateTemplate;
import org.modelspartiti.formalisms.san.sant.InputArc;
import org.modelspartiti.formalisms.san.sant.InputGateTemplate;
import org.modelspartiti.formalisms.san.sant.InstantaneousActivityTemplate;
import org.modelspartiti.formalisms.san.sant.MarkingTemplate;
import org.modelspartiti.formalisms.san.sant.MarkingTemplateGlobalVariable;
import org.modelspartiti.formalisms.san.sant.MarkingTemplateSimple;
import org.modelspartiti.formalisms.san.sant.MultiplicityRangeOperator;
import org.modelspartiti.formalisms.san.sant.OutputArc;
import org.modelspartiti.formalisms.san.sant.OutputGate;
...
import org.modelspartiti.formalisms.san.sant.SANTFactory;
...
public class SANTPackageImpl extends EPackageImpl implements SANTPackage {
	 ...
	 * @see org.modelspartiti.formalisms.san.sant.SANTPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(santEClass, org.modelspartiti.formalisms.san.sant.SANT.class, "SANT", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSANT_Name(), ecorePackage.getEString(), "name", null, 1, 1, org.modelspartiti.formalisms.san.sant.SANT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSANT_TemplatePlaces(), this.getPlaceTemplate(), null, "templatePlaces", null, 0, -1, org.modelspartiti.formalisms.san.sant.SANT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSANT_TemplatePlaces().getEKeys().add(theSANPackage.getNamedElement_Name());
		initEReference(getSANT_Places(), theSANPackage.getPlace(), null, "places", null, 0, -1, org.modelspartiti.formalisms.san.sant.SANT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSANT_ActivityTemplates(), this.getActivityTemplate(), null, "activityTemplates", null, 0, -1, org.modelspartiti.formalisms.san.sant.SANT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSANT_ActivityTemplates().getEKeys().add(theSANPackage.getNamedElement_Name());
		initEReference(getSANT_Parameters(), theCorePackage.getParameter(), null, "parameters", null, 0, -1, org.modelspartiti.formalisms.san.sant.SANT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSANT_Parameters().getEKeys().add(theCorePackage.getParameter_Name());
		initEReference(getSANT_GlobalVariables(), theSANPackage.getGlobalVariable(), null, "globalVariables", null, 0, -1, org.modelspartiti.formalisms.san.sant.SANT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSANT_GlobalVariables().getEKeys().add(theSANPackage.getNamedElement_Name());
		initEReference(getSANT_CustomType(), theSANPackage.getCustomTypeDefinition(), null, "customType", null, 0, -1, org.modelspartiti.formalisms.san.sant.SANT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSANT_Gates(), this.getGateTemplate(), null, "gates", null, 0, -1, org.modelspartiti.formalisms.san.sant.SANT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSANT_Arcs(), this.getArcTemplate(), null, "arcs", null, 0, -1, org.modelspartiti.formalisms.san.sant.SANT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
