...
import org.modelspartiti.formalisms.san.san.Arc;
import org.modelspartiti.formalisms.san.san.Array;
import org.modelspartiti.formalisms.san.san.Beta;
import org.modelspartiti.formalisms.san.san.Binomial;
import org.modelspartiti.formalisms.san.san.Case;
import org.modelspartiti.formalisms.san.san.ComplexType;
import org.modelspartiti.formalisms.san.san.ConditionalWeibull;
import org.modelspartiti.formalisms.san.san.CustomTypeArray;
import org.modelspartiti.formalisms.san.san.CustomTypeDefinition;
import org.modelspartiti.formalisms.san.san.CustomTypeStruct;
import org.modelspartiti.formalisms.san.san.Deterministic;
import org.modelspartiti.formalisms.san.san.Distribution;
import org.modelspartiti.formalisms.san.san.Erlang;
import org.modelspartiti.formalisms.san.san.Exponential;
import org.modelspartiti.formalisms.san.san.Expression;
import org.modelspartiti.formalisms.san.san.ExpressionMarking;
import org.modelspartiti.formalisms.san.san.ExpressionSegment;
import org.modelspartiti.formalisms.san.san.ExpressionText;
import org.modelspartiti.formalisms.san.san.ExpressionVariable;
import org.modelspartiti.formalisms.san.san.ExtendedPlaceType;
import org.modelspartiti.formalisms.san.san.Field;
import org.modelspartiti.formalisms.san.san.Gamma;
import org.modelspartiti.formalisms.san.san.Gate;
import org.modelspartiti.formalisms.san.san.Geometric;
import org.modelspartiti.formalisms.san.san.GlobalVariable;
import org.modelspartiti.formalisms.san.san.HyperExponential;
import org.modelspartiti.formalisms.san.san.HypoExponential;
import org.modelspartiti.formalisms.san.san.InputArc;
import org.modelspartiti.formalisms.san.san.InputGate;
import org.modelspartiti.formalisms.san.san.InstantaneousActivity;
import org.modelspartiti.formalisms.san.san.LeafNode;
import org.modelspartiti.formalisms.san.san.LeafNodeGlobalVariable;
import org.modelspartiti.formalisms.san.san.LeafNodeString;
import org.modelspartiti.formalisms.san.san.LeafNodeStruct;
import org.modelspartiti.formalisms.san.san.Lognormal;
import org.modelspartiti.formalisms.san.san.Marking;
import org.modelspartiti.formalisms.san.san.MarkingExtended;
import org.modelspartiti.formalisms.san.san.MarkingGlobalVariable;
import org.modelspartiti.formalisms.san.san.MarkingSimple;
import org.modelspartiti.formalisms.san.san.NamedElement;
import org.modelspartiti.formalisms.san.san.NegativeBinomial;
import org.modelspartiti.formalisms.san.san.Node;
import org.modelspartiti.formalisms.san.san.Normal;
import org.modelspartiti.formalisms.san.san.OutputArc;
import org.modelspartiti.formalisms.san.san.OutputGate;
import org.modelspartiti.formalisms.san.san.Pareto;
import org.modelspartiti.formalisms.san.san.Place;
import org.modelspartiti.formalisms.san.san.PrimitiveType;
import org.modelspartiti.formalisms.san.san.SANFactory;
import org.modelspartiti.formalisms.san.san.SANPackage;
import org.modelspartiti.formalisms.san.san.TimedActivity;
import org.modelspartiti.formalisms.san.san.Triangular;
import org.modelspartiti.formalisms.san.san.Type;
import org.modelspartiti.formalisms.san.san.Uniform;
import org.modelspartiti.formalisms.san.san.VariableType;
import org.modelspartiti.formalisms.san.san.Weibull;
...
public class SANPackageImpl extends EPackageImpl implements SANPackage {
	 ...
	 * @see org.modelspartiti.formalisms.san.san.SANPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(sanEClass, org.modelspartiti.formalisms.san.san.SAN.class, "SAN", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSAN_Places(), this.getPlace(), null, "places", null, 1, -1, org.modelspartiti.formalisms.san.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSAN_Places().getEKeys().add(this.getNamedElement_Name());
		initEAttribute(getSAN_Name(), ecorePackage.getEString(), "name", null, 1, 1, org.modelspartiti.formalisms.san.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSAN_Activities(), this.getActivity(), null, "activities", null, 0, -1, org.modelspartiti.formalisms.san.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSAN_Activities().getEKeys().add(this.getNamedElement_Name());
		initEReference(getSAN_GlobalVariables(), this.getGlobalVariable(), null, "globalVariables", null, 0, -1, org.modelspartiti.formalisms.san.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSAN_GlobalVariables().getEKeys().add(this.getNamedElement_Name());
		initEReference(getSAN_Arcs(), this.getArc(), null, "arcs", null, 0, -1, org.modelspartiti.formalisms.san.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSAN_Gates(), this.getGate(), null, "gates", null, 0, -1, org.modelspartiti.formalisms.san.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSAN_Gates().getEKeys().add(this.getNamedElement_Name());
		initEReference(getSAN_Initialization(), this.getExpression(), null, "initialization", null, 0, -1, org.modelspartiti.formalisms.san.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSAN_Customtype(), this.getCustomTypeDefinition(), null, "customtype", null, 0, -1, org.modelspartiti.formalisms.san.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
