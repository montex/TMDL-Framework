 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelspartiti.formalisms.san.san.impl.GeometricImpl#getP <em>P</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeometricImpl extends DistributionImpl implements Geometric {
	...
	protected EClass eStaticClass() {
		return SANPackage.Literals.GEOMETRIC;
	}
	...
	public NotificationChain basicSetP(Expression newP, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SANPackage.GEOMETRIC__P, oldP, newP);
	...
	public void setP(Expression newP) {
		if (newP != p) {
			...
			if (p != null)
				msgs = ((InternalEObject)p).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SANPackage.GEOMETRIC__P, null, msgs);
			if (newP != null)
				msgs = ((InternalEObject)newP).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SANPackage.GEOMETRIC__P, null, msgs);
			msgs = basicSetP(newP, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANPackage.GEOMETRIC__P, newP, newP));
	}
