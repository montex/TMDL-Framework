 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelspartiti.formalisms.san.san.impl.GlobalVariableImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GlobalVariableImpl extends NamedElementImpl implements GlobalVariable {
	 ...
	 * @ordered
	 */
	protected static final VariableType TYPE_EDEFAULT = VariableType.INT;
	...
	protected EClass eStaticClass() {
		return SANPackage.Literals.GLOBAL_VARIABLE;
	}
	...
	public void setType(VariableType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANPackage.GLOBAL_VARIABLE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SANPackage.GLOBAL_VARIABLE__TYPE:
				return getType();
		}
