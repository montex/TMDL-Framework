 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelspartiti.formalisms.san.san.impl.DistributionImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DistributionImpl extends MinimalEObjectImpl.Container implements Distribution {
	...
	protected EClass eStaticClass() {
		return SANPackage.Literals.DISTRIBUTION;
	}
	...
	public void setParameters(String newParameters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANPackage.DISTRIBUTION__PARAMETERS, oldParameters, parameters));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SANPackage.DISTRIBUTION__PARAMETERS:
