...
import org.modelspartiti.formalisms.san.Arc;
import org.modelspartiti.formalisms.san.Array;
import org.modelspartiti.formalisms.san.Beta;
import org.modelspartiti.formalisms.san.Binomial;
import org.modelspartiti.formalisms.san.Case;
import org.modelspartiti.formalisms.san.ComplexType;
import org.modelspartiti.formalisms.san.ConditionalWeibull;
import org.modelspartiti.formalisms.san.CustomTypeArray;
import org.modelspartiti.formalisms.san.CustomTypeDefinition;
import org.modelspartiti.formalisms.san.CustomTypeStruct;
import org.modelspartiti.formalisms.san.Deterministic;
import org.modelspartiti.formalisms.san.Distribution;
import org.modelspartiti.formalisms.san.Erlang;
import org.modelspartiti.formalisms.san.Exponential;
import org.modelspartiti.formalisms.san.Expression;
import org.modelspartiti.formalisms.san.ExpressionMarking;
import org.modelspartiti.formalisms.san.ExpressionSegment;
import org.modelspartiti.formalisms.san.ExpressionText;
import org.modelspartiti.formalisms.san.ExpressionVariable;
import org.modelspartiti.formalisms.san.ExtendedPlaceType;
import org.modelspartiti.formalisms.san.Field;
import org.modelspartiti.formalisms.san.Gamma;
import org.modelspartiti.formalisms.san.Gate;
import org.modelspartiti.formalisms.san.Geometric;
...
import org.modelspartiti.formalisms.san.InputArc;
import org.modelspartiti.formalisms.san.InputGate;
import org.modelspartiti.formalisms.san.InstantaneousActivity;
import org.modelspartiti.formalisms.san.LeafNode;
import org.modelspartiti.formalisms.san.LeafNodeGlobalVariable;
import org.modelspartiti.formalisms.san.LeafNodeString;
import org.modelspartiti.formalisms.san.LeafNodeStruct;
import org.modelspartiti.formalisms.san.Lognormal;
import org.modelspartiti.formalisms.san.Marking;
import org.modelspartiti.formalisms.san.MarkingExtended;
import org.modelspartiti.formalisms.san.MarkingGlobalVariable;
import org.modelspartiti.formalisms.san.MarkingSimple;
import org.modelspartiti.formalisms.san.NamedElement;
import org.modelspartiti.formalisms.san.NegativeBinomial;
import org.modelspartiti.formalisms.san.Node;
import org.modelspartiti.formalisms.san.Normal;
import org.modelspartiti.formalisms.san.OutputArc;
import org.modelspartiti.formalisms.san.OutputGate;
import org.modelspartiti.formalisms.san.Pareto;
import org.modelspartiti.formalisms.san.Place;
import org.modelspartiti.formalisms.san.PrimitiveType;
import org.modelspartiti.formalisms.san.SANFactory;
import org.modelspartiti.formalisms.san.SANPackage;
import org.modelspartiti.formalisms.san.TimedActivity;
import org.modelspartiti.formalisms.san.Triangular;
import org.modelspartiti.formalisms.san.Type;
import org.modelspartiti.formalisms.san.Uniform;
import org.modelspartiti.formalisms.san.VariableType;
import org.modelspartiti.formalisms.san.Weibull;
...
public class SANPackageImpl extends EPackageImpl implements SANPackage {
	 ...
	 * @see org.modelspartiti.formalisms.san.SANPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(sanEClass, org.modelspartiti.formalisms.san.SAN.class, "SAN", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSAN_Places(), this.getPlace(), null, "places", null, 1, -1, org.modelspartiti.formalisms.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSAN_Places().getEKeys().add(this.getNamedElement_Name());
		initEAttribute(getSAN_Name(), ecorePackage.getEString(), "name", null, 1, 1, org.modelspartiti.formalisms.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSAN_Activities(), this.getActivity(), null, "activities", null, 0, -1, org.modelspartiti.formalisms.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSAN_Activities().getEKeys().add(this.getNamedElement_Name());
		initEReference(getSAN_GlobalVariables(), this.getGlobalVariable(), null, "globalVariables", null, 0, -1, org.modelspartiti.formalisms.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSAN_GlobalVariables().getEKeys().add(this.getNamedElement_Name());
		initEReference(getSAN_Arcs(), this.getArc(), null, "arcs", null, 0, -1, org.modelspartiti.formalisms.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSAN_Gates(), this.getGate(), null, "gates", null, 0, -1, org.modelspartiti.formalisms.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSAN_Gates().getEKeys().add(this.getNamedElement_Name());
		initEReference(getSAN_Initialization(), this.getExpression(), null, "initialization", null, 0, -1, org.modelspartiti.formalisms.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSAN_Customtype(), this.getCustomTypeDefinition(), null, "customtype", null, 0, -1, org.modelspartiti.formalisms.san.SAN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
