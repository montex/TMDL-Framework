...
public interface Pareto extends Distribution {
	 ...
	 * @see san.SANPackage#getPareto_LowerBound()
	...
	/**
	 * Sets the value of the '{@link san.Pareto#getLowerBound <em>Lower Bound</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see san.SANPackage#getPareto_Shape()
	 * @model containment="true" required="true"
	 * @generated
	 */
	Expression getShape();
	...
	/**
	 * Sets the value of the '{@link san.Pareto#getShape <em>Shape</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
