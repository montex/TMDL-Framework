 ...
 * <ul>
 *   <li>{@link san.impl.MarkingExtendedImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MarkingExtendedImpl extends MarkingImpl implements MarkingExtended {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANPackage.MARKING_EXTENDED__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SANPackage.MARKING_EXTENDED__VALUE:
				return getValue();
		}
