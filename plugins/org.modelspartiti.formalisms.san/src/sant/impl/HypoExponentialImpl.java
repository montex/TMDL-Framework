 ...
 * <ul>
 *   <li>{@link sant.impl.HypoExponentialImpl#getRate0 <em>Rate0</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HypoExponentialImpl extends DistributionImpl implements HypoExponential {
	...
	protected EClass eStaticClass() {
		return SANTPackage.Literals.HYPO_EXPONENTIAL;
	}
	...
	public NotificationChain basicSetRate0(Expression newRate0, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SANTPackage.HYPO_EXPONENTIAL__RATE0, oldRate0, newRate0);
	...
	public void setRate0(Expression newRate0) {
		if (newRate0 != rate0) {
			...
			if (rate0 != null)
				msgs = ((InternalEObject)rate0).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SANTPackage.HYPO_EXPONENTIAL__RATE0, null, msgs);
			if (newRate0 != null)
				msgs = ((InternalEObject)newRate0).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SANTPackage.HYPO_EXPONENTIAL__RATE0, null, msgs);
			msgs = basicSetRate0(newRate0, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANTPackage.HYPO_EXPONENTIAL__RATE0, newRate0, newRate0));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SANTPackage.HYPO_EXPONENTIAL__RATE0:
