 ...
 * <ul>
 *   <li>{@link sant.impl.ExpressionVariableImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExpressionVariableImpl extends MinimalEObjectImpl.Container implements ExpressionVariable {
	...
	protected EClass eStaticClass() {
		return SANTPackage.Literals.EXPRESSION_VARIABLE;
	}
		...
		if (variable != null && variable.eIsProxy()) {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SANTPackage.EXPRESSION_VARIABLE__VARIABLE, oldVariable, variable));
			}
		}
		return variable;
	}
	...
	public void setVariable(GlobalVariable newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANTPackage.EXPRESSION_VARIABLE__VARIABLE, oldVariable, variable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SANTPackage.EXPRESSION_VARIABLE__VARIABLE:
