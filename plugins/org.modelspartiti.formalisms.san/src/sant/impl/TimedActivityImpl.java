 ...
 * <ul>
 *   <li>{@link sant.impl.TimedActivityImpl#getTimeDistribution <em>Time Distribution</em>}</li>
 *   <li>{@link sant.impl.TimedActivityImpl#getActivation <em>Activation</em>}</li>
 *   <li>{@link sant.impl.TimedActivityImpl#getReactivation <em>Reactivation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimedActivityImpl extends ActivityImpl implements TimedActivity {
	...
	protected EClass eStaticClass() {
		return SANTPackage.Literals.TIMED_ACTIVITY;
	}
	...
	public NotificationChain basicSetTimeDistribution(Distribution newTimeDistribution, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SANTPackage.TIMED_ACTIVITY__TIME_DISTRIBUTION, oldTimeDistribution, newTimeDistribution);
	...
	public void setTimeDistribution(Distribution newTimeDistribution) {
		if (newTimeDistribution != timeDistribution) {
			...
			if (timeDistribution != null)
				msgs = ((InternalEObject)timeDistribution).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SANTPackage.TIMED_ACTIVITY__TIME_DISTRIBUTION, null, msgs);
			if (newTimeDistribution != null)
				msgs = ((InternalEObject)newTimeDistribution).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SANTPackage.TIMED_ACTIVITY__TIME_DISTRIBUTION, null, msgs);
			msgs = basicSetTimeDistribution(newTimeDistribution, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANTPackage.TIMED_ACTIVITY__TIME_DISTRIBUTION, newTimeDistribution, newTimeDistribution));
	}
	...
	public NotificationChain basicSetActivation(Expression newActivation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SANTPackage.TIMED_ACTIVITY__ACTIVATION, oldActivation, newActivation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setActivation(Expression newActivation) {
		if (newActivation != activation) {
			NotificationChain msgs = null;
			if (activation != null)
				msgs = ((InternalEObject)activation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SANTPackage.TIMED_ACTIVITY__ACTIVATION, null, msgs);
			if (newActivation != null)
				msgs = ((InternalEObject)newActivation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SANTPackage.TIMED_ACTIVITY__ACTIVATION, null, msgs);
			msgs = basicSetActivation(newActivation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANTPackage.TIMED_ACTIVITY__ACTIVATION, newActivation, newActivation));
	}
	...
	public NotificationChain basicSetReactivation(Expression newReactivation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SANTPackage.TIMED_ACTIVITY__REACTIVATION, oldReactivation, newReactivation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReactivation(Expression newReactivation) {
		if (newReactivation != reactivation) {
			...
			if (reactivation != null)
				msgs = ((InternalEObject)reactivation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SANTPackage.TIMED_ACTIVITY__REACTIVATION, null, msgs);
			if (newReactivation != null)
				msgs = ((InternalEObject)newReactivation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SANTPackage.TIMED_ACTIVITY__REACTIVATION, null, msgs);
			msgs = basicSetReactivation(newReactivation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANTPackage.TIMED_ACTIVITY__REACTIVATION, newReactivation, newReactivation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SANTPackage.TIMED_ACTIVITY__TIME_DISTRIBUTION:
				return basicSetTimeDistribution(null, msgs);
			case SANTPackage.TIMED_ACTIVITY__ACTIVATION:
				return basicSetActivation(null, msgs);
			case SANTPackage.TIMED_ACTIVITY__REACTIVATION:
