...
public class ExpressionActivityCasesNumberImpl extends MinimalEObjectImpl.Container implements ExpressionActivityCasesNumber {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate EVALUATE_LIST__EINVOCATION_DELEGATE = ((EOperation.Internal)SANTPackage.Literals.EXPRESSION_ACTIVITY_CASES_NUMBER___EVALUATE__LIST).getInvocationDelegate();
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == TemplateExpressionInteger.class) {
			switch (baseOperationID) {
				case ExpressionsPackage.TEMPLATE_EXPRESSION_INTEGER___EVALUATE__LIST: return SANTPackage.EXPRESSION_ACTIVITY_CASES_NUMBER___EVALUATE__LIST;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SANTPackage.EXPRESSION_ACTIVITY_CASES_NUMBER___EVALUATE__LIST:
