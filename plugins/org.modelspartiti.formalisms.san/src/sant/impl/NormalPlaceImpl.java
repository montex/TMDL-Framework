 ...
 * <ul>
 *   <li>{@link sant.impl.NormalPlaceImpl#getMarking <em>Marking</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NormalPlaceImpl extends PlaceImpl implements NormalPlace {
	...
	protected EClass eStaticClass() {
		return SANTPackage.Literals.NORMAL_PLACE;
	}
	...
	public NotificationChain basicSetMarking(MarkingSimple newMarking, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SANTPackage.NORMAL_PLACE__MARKING, oldMarking, newMarking);
	...
	public void setMarking(MarkingSimple newMarking) {
		if (newMarking != marking) {
			...
			if (marking != null)
				msgs = ((InternalEObject)marking).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SANTPackage.NORMAL_PLACE__MARKING, null, msgs);
			if (newMarking != null)
				msgs = ((InternalEObject)newMarking).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SANTPackage.NORMAL_PLACE__MARKING, null, msgs);
			msgs = basicSetMarking(newMarking, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANTPackage.NORMAL_PLACE__MARKING, newMarking, newMarking));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SANTPackage.NORMAL_PLACE__MARKING:
