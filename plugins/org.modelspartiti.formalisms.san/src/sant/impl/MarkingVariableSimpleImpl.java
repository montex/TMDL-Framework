 ...
 * <ul>
 *   <li>{@link sant.impl.MarkingVariableSimpleImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MarkingVariableSimpleImpl extends MarkingSimpleImpl implements MarkingVariableSimple {
	...
	protected EClass eStaticClass() {
		return SANTPackage.Literals.MARKING_VARIABLE_SIMPLE;
	}
		...
		if (variable != null && variable.eIsProxy()) {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SANTPackage.MARKING_VARIABLE_SIMPLE__VARIABLE, oldVariable, variable));
			}
		}
		return variable;
	}
	...
	public void setVariable(GlobalVariable newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANTPackage.MARKING_VARIABLE_SIMPLE__VARIABLE, oldVariable, variable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SANTPackage.MARKING_VARIABLE_SIMPLE__VARIABLE:
