 ...
 * <ul>
 *   <li>{@link sant.impl.GlobalVariableImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GlobalVariableImpl extends NamedElementImpl implements GlobalVariable {
	...
	protected EClass eStaticClass() {
		return SANTPackage.Literals.GLOBAL_VARIABLE;
	}
	...
	public void setType(VariableType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SANTPackage.GLOBAL_VARIABLE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SANTPackage.GLOBAL_VARIABLE__TYPE:
				return getType();
		}
