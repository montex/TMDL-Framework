 ...
 * <ul>
 *   <li>{@link sant.Gamma#getAlpha <em>Alpha</em>}</li>
 *   <li>{@link sant.Gamma#getBeta <em>Beta</em>}</li>
 * </ul>
 * </p>
 *
 * @see sant.SANTPackage#getGamma()
 * @model
 * @generated
 */
public interface Gamma extends Distribution {
	 ...
	 * @see sant.SANTPackage#getGamma_Alpha()
	...
	/**
	 * Sets the value of the '{@link sant.Gamma#getAlpha <em>Alpha</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see sant.SANTPackage#getGamma_Beta()
	 * @model containment="true" required="true"
	 * @generated
	 */
	Expression getBeta();
	...
	/**
	 * Sets the value of the '{@link sant.Gamma#getBeta <em>Beta</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
