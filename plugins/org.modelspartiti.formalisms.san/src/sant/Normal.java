 ...
 * <ul>
 *   <li>{@link sant.Normal#getMean <em>Mean</em>}</li>
 *   <li>{@link sant.Normal#getVariance <em>Variance</em>}</li>
 * </ul>
 * </p>
 *
 * @see sant.SANTPackage#getNormal()
 * @model
 * @generated
 */
public interface Normal extends Distribution {
	 ...
	 * @see sant.SANTPackage#getNormal_Mean()
	...
	/**
	 * Sets the value of the '{@link sant.Normal#getMean <em>Mean</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see sant.SANTPackage#getNormal_Variance()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link sant.Normal#getVariance <em>Variance</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
